...
See the xref:management-center:monitor-imdg:cluster-administration.adoc#hot-restart[Hot Restart functionality^]
...
[blue]*Hazelcast IMDG Pro Feature*
...
----
include::{javasource}/storage/SampleEncryptionAtRestConfiguration.java[tag=vault]
>>>>>>> 7b1bad05... Updating the Pro & Enterprise features section which was out of date.
----