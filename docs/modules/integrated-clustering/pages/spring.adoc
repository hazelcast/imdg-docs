...
NOTE: To enable Spring integration, either `hazelcast-spring-{page-component-display-version}.jar`
or `hazelcast-all-{page-component-display-version}.jar` must be in the classpath.
