...
https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#monitoring-wan-replication[Clear Queues action^] or
...
NOTE: WAN synchronization strategies (neither the default nor the xref:advanced-features.adoc#delta-wan-synchronization[])
