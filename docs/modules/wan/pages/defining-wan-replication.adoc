...
Please see also the xref:clusters:advanced-network-configuration.adoc#setting-up-wan-endpoints-configuration[Setting Up WAN Endpoints Configuration section]
...
xref:tuning.adoc[Fine-Tuning WAN Replication section] section for more information.
...
https://github.com/hazelcast/hazelcast-aws[Hazelcast AWS discovery plugin^],
https://github.com/hazelcast/hazelcast-azure[Hazelcast Azure discovery plugin^],
https://github.com/hazelcast/hazelcast-gcp[Hazelcast GCP discovery plugin^], or similar.
...
* https://github.com/hazelcast/hazelcast-azure/blob/master/README.md#configuration-for-wan-replication-target-cluster-discovery[Microsoft Azure^]
* https://github.com/hazelcast/hazelcast-gcp/blob/master/README.md#configuration[Google Cloud Platform (GCP)^]
* https://github.com/hazelcast/hazelcast-kubernetes#configuration[Kubernetes^]
...
* https://github.com/hazelcast/hazelcast-jclouds/blob/master/README.md#discovering-members-with-jclouds[jclouds®^]
