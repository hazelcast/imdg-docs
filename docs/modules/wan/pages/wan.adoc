...
its API is available publicly https://docs.hazelcast.org/docs/latest/javadoc/com/hazelcast/wan/package-summary.html[here^] and,
...
include::defining-wan-replication.adoc[leveloffset=+1]

include::configuring-for-map-and-cache.adoc[leveloffset=+1]

include::advanced-features.adoc[leveloffset=+1]

include::tuning.adoc[leveloffset=+1]

include::failures.adoc[leveloffset=+1]
