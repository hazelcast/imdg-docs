...
NOTE: Replication over WAN is a Hazelcast IMDG Enterprise Edition feature. However,
...
NOTE: Replication over WAN is supported between all Hazelcast 4.x.x versions.
