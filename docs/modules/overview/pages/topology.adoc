...
See the xref:clients:hazelcast-clients.adoc[Hazelcast Clients chapter] for information on the clients and other language implementations. 
...
See the xref:clients:java.adoc#configuring-client-near-cache[Configuring Client Near Cache section].