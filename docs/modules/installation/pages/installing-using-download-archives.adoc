...
These scripts start/stop a Hazelcast member. See the xref:getting-started:getting-started.adoc#creating-a-cluster[Quick Start chapter] to see the start scripts in action.
