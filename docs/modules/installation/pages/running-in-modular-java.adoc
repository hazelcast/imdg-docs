...
* `com.hazelcast.core` for `hazelcast-{page-component-display-version}.jar` and
`hazelcast-enterprise-{page-component-display-version}.jar`

Don't use `hazelcast-all-{page-component-display-version}.jar` or
`hazelcast-enterprise-all-{page-component-display-version}.jar` on the modulepath as it could
...
java --add-modules java.se \
  ...
  -jar hazelcast-{page-component-display-version}.jar
----
...
_This example expects `hazelcast-{page-component-display-version}.jar` placed in the `lib` directory._