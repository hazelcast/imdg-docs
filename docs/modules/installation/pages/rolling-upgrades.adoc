...
is supported in the open source and Enterprise editions of Hazelcast IMDG.
...
* Using xref:management-center:ROOT:index.adoc#rolling-upgrade[Management Center].
