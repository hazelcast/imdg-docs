...
upgrade on a cluster running Hazelcast IMDG Enterprise 4.1 to Hazelcast
IMDG Enterprise 4.2. Rolling upgrade for minor versions is supported in the
...
Hazelcast. For example, Management Center 4.2 works with both Hazelcast IMDG
