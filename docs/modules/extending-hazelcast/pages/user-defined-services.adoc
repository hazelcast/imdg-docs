...
Now, it is time to implement the `CounterProxy` as shown below. `CounterProxy` extends `AbstractDistributedObject`, source code is https://docs.hazelcast.org/docs/{full-version}/javadoc/com/hazelcast/spi/AbstractDistributedObject.html[here].
...
https://docs.hazelcast.org/docs/{full-version}/javadoc/com/hazelcast/spi/BackupOperation.html[here].
