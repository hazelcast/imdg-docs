...
* `memberAttributeChanged`: An attribute of a member is changed. See the xref:management:cluster-utilities.adoc#defining-member-attributes[Defining Member Attributes section] to learn about member attributes.
