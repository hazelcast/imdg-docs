...
https://github.com/hazelcast/hazelcast-azure[Hazelcast Azure^] or
https://github.com/hazelcast/hazelcast-jclouds[Hazelcast jclouds^] 
...
to the Hazelcast xref:management:cluster-utilities.adoc#defining-member-attributes[member attributes] map during the
