...
class or the xref:query:how-distributed-query-works.adoc#indexing-queries[`addIndex`] method, then
...
See the xref:events:object-events.adoc#listening-for-map-events[Listening for Map Events section].
...
xref:events:object-events.adoc#listening-for-map-events[Listening for Map Events section] for
