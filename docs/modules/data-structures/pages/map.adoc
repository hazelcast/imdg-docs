...
you can use Hazelcast's link:{javadocBaseUrl}/javadoc/com/hazelcast/map/MapStore.html[`MapStore`] and
link:{javadocBaseUrl}/javadoc/com/hazelcast/map/MapLoader.html[`MapLoader`] interfaces.
