...
as you can see in the interface https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/map/MapStore.html[code^].
...
https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/config/MapStoreConfig.html[MapStoreConfig^]
...
https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/config/IndexConfig.html[IndexConfig^]
