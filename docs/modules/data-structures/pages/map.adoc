...
you can use Hazelcast's link:{javadocBaseUrl}{page-component-version}/javadoc/com/hazelcast/map/MapStore.html[`MapStore`] and
link:{javadocBaseUrl}{page-component-version}/javadoc/com/hazelcast/map/MapLoader.html[`MapLoader`] interfaces.
...
For this, you should set `per-entry-statistics-enabled` under the map configuration as
