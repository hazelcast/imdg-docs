...
programmatically using the method https://docs.hazelcast.org/docs/{full-version}/javadoc/com/hazelcast/config/CardinalityEstimatorConfig.html[setQuorunName()^],
