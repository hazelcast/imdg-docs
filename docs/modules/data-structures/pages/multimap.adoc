...
* `quorum-ref`: Name of quorum configuration that you want this MultiMap to use.
...
The following is a list of methods that support split-brain protection checks. The list is grouped by quorum type.
