...
{jet-docs}[Hazelcast Jet^], IList can also be used by it for unit
testing or similar non-production situations. See the {jet-docs}[Hazelcast Jet Reference Manual] to learn how Jet can use IList, e.g., how it can fill
