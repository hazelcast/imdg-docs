...
* `quorum-ref`: Name of quorum configuration that you want this List to use.
...
the method https://docs.hazelcast.org/docs/{full-version}/javadoc/com/hazelcast/config/ListConfig.html[setSplitBrainProtectionName()^],
