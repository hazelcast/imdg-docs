...
See the https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#changing-cluster-client-filtering[Hazelcast Management Center Reference Manual^] for information on blacklisting the clients.
...
https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#monitoring-clients[Monitoring Clients section^]
...
See the https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#monitoring-clients[Monitoring Clients section^]
