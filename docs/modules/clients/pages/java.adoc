...
For this, you simply enable Hazelcast {hazelcast-cloud} and specify the cluster's discovery token provided by Hazelcast {hazelcast-cloud} while creating the cluster; this allows the Hazelcast cluster to discover your clients.
...
See this Hazelcast {hazelcast-cloud} https://hazelcast.com/products/cloud/[web page^]
for more information.
...
See the xref:management-center:monitor-imdg:monitor-clients.adoc[Monitoring Clients section]
