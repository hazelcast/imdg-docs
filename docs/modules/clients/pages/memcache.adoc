...
NOTE: The `hazelcast.memcache.enabled` system property has been deprecated. Please use either one of the above configurations to enable the Memcache client request listener service.
