...
xref:fast-aggregations.adoc[Fast-Aggregations] and https://jet.hazelcast.org/[Hazelcast Jet]
...
See the xref:fast-aggregations.adoc[Fast Aggregations section] for examples. If you
