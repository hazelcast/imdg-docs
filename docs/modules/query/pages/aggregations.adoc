...
NOTE: If the xref:dds.adoc#setting-in-memory-format[in-memory format] of your data is `NATIVE`,
...
{docBaseUrl}/javadoc/com/hazelcast/aggregation/Aggregator.html[Aggregator Javadoc^]
...
to its {docBaseUrl}/javadoc/com/hazelcast/map/IMap.html#aggregate-com.hazelcast.aggregation.Aggregator-[Javadoc^]
