...
* `quorum-ref`: Name of quorum configuration that you want this Durable Executor Service to use. See the <<split-brain-protection-for-durable-executor-service, Split-Brain Protection for Durable Executor Service section>>.
