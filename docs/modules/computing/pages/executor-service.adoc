...
'''
NOTE: Note that you may want to use https://jet.hazelcast.org/[Hazelcast Jet^] if you want to process batch or real-time streaming data. See the https://hazelcast.org/use-cases/fast-batch-processing/[Fast Batch Processing^] and https://hazelcast.org/use-cases/real-time-stream-processing/[Real-Time Stream Processing^] use cases for Hazelcast Jet.
