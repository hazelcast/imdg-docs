...
* https://github.com/hazelcast/hazelcast-cpp-client/blob/master/Reference_Manual.md#42-portable_serializer-serialization[C++^]
* https://github.com/hazelcast/hazelcast-nodejs-client/blob/master/DOCUMENTATION.md#42-portable-serialization[Node.js^]
* https://hazelcast.readthedocs.io/en/stable/serialization.html#portable-serialization[Python^]
