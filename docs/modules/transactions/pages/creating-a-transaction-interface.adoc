...
{docBaseUrl}/javadoc/com/hazelcast/transaction/TransactionContext.html[here^].
...
See the <<providing-xa-transactions, XA Transactions section>> for
further information.

== ONE_PHASE vs. TWO_PHASE

As discussed in <<creating-a-transaction-interface, Creating a Transaction
