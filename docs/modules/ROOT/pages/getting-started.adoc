...
* Form a cluster not just on your local machine: see xref:deploy:setting_up-clusters.adoc[Setting Up Clusters].
* Start using our distributed data structures: see xref:reference:distributed_data-structures.adoc[Distributed Data Structures].
* Learn how to configure Hazelcast IMDG: see xref:reference:understanding-configuration.adoc[Understanding Configuration].
