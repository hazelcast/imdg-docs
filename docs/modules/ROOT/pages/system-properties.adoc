...
| null
| string
| https://hazelcast.com/products/[Hazelcast IMDG Enterprise^] license key.
...
See https://docs.oracle.com/javase/7/docs/api/java/nio/ByteBuffer.html[here^] for more information.
