...
| true
| bool
| Enable Hazelcast shutdownhook thread. This property should be considered with `hazelcast.shutdownhook.policy`
whose default value is `TERMINATE`; so when enabled (default behavior), this thread terminates
