...
The phone home code itself is open source. See the code https://docs.hazelcast.org/docs/{page-component-display-version}/javadoc/com/hazelcast/util/PhoneHome.html[here].
