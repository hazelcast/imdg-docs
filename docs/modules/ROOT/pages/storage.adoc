...
The optional `persistent-memory` element under the `native-memory`
...
The following snippets demonstrate how to configure the persistent memory as
...
See the https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#hot-restart[Hot Restart functionality^]
...
https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#hot-restart[Management Center^],
...
of the https://hazelcast.com/resources/hazelcast-deployment-operations-guide/[Hazelcast IMDG Operations and Deployment Guide^].
...
image:ROOT:HotRestartPerf.png[Hot Restart Perf]
...
image:ROOT:HotRestartPerf2.png[Hot Restart Perf2]
