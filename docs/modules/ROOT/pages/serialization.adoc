...
As mentioned in <<implementing-java-serializable-and-externalizable, Implementing Java Serializable & Externalizable>>,
...
<<implementing-portable-serialization, Portable>>.
...
NOTE: See the <<serialization-configuration-wrap-up, Serialization Configuration Wrap-Up section>>
...
{docBaseUrl}/javadoc/com/hazelcast/nio/serialization/VersionedPortable.html[VersionedPortable^]
...
or manually register a class definition in serialization configuration as shown below.
...
<<custom-serialization, Custom Serialization section>>.
