...
(IMDG Enterprise (4.x) and IMDG Enterprise HD (3.12.x)) can contact
...
The following methods of https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/client/config/ClientConfig.html[ClientConfig^] have been refactored:
...
Also the `ClientAwsConfig` class has been renamed as https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/config/AwsConfig.html[AwsConfig^].
...
* https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/query/extractor/ValueCallback.html[ValueCallback^]
* https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/query/extractor/ValueExtractor.html[ValueExtractor^]
...
See the https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/partition/MigrationListener.html[MigrationListener^] Javadoc
for a full insight.
...
See the following table for the before/after sample https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/security/IPermissionPolicy.html[IPermissionPolicy^] implementations.
...
The `getId()` method of the https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/nio/serialization/IdentifiedDataSerializable.html[IdentifiedDataSerializable^] interface
...
of https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/map/EntryProcessor.html[EntryProcessor^] which now defines how the entries will be processed
...
The https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/projection/Projection.html[Projection^] class was an abstract interface for historical reasons.
...
See the https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/config/ServiceConfig.html[here^]
...
See the https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/core/HazelcastInstance.html[here^]
...
See the https://docs.hazelcast.org/docs/{page-component-version}/javadoc/com/hazelcast/core/DistributedObjectEvent.html[here^]
