...
and WAN replications. See the https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html[documentation^] for details on Hazelcast Management Center.
...
are more definite. See the xref:clusters:discovery-mechanisms.adoc[Discovery Mechanisms section].
...
+
* Now, add the `hazelcast-client-`*`{page-component-display-version}`*`.jar` library to your classpath.
