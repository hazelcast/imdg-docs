...
[source,java]
----
include::{javasource}/networkpartitioning/MemberCountSplitBrainProtection.java[tag=mcq]
----
====
...
[source,java]
----
include::{javasource}/networkpartitioning/ProbabilisticSplitBrainProtection.java[tag=pq]
----
====
...
[source,java]
----
include::{javasource}/networkpartitioning/RecentlyActiveSplitBrainProtection.java[tag=raq]
----
====
...
[source,java]
----
include::{javasource}/networkpartitioning/SplitBrainProtectionListenerConfiguration.java[tag=qlc]
----
====
...
[source,java]
----
include::{javasource}/networkpartitioning/SplitBrainProtectionQuery.java[tag=qq]
----
...
(See the <<failure-detector-configuration, Failure Detector Configuration section>>
